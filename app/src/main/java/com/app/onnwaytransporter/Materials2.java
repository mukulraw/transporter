...
public class Materials2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.enqueue(new Callback<List<truckTypeBean>>() {
            ...
            public void onResponse(Call<List<truckTypeBean>> call, Response<List<truckTypeBean>> response) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(Materials2.this,
        ...
        call2.enqueue(new Callback<List<truckTypeBean>>() {
            ...
            public void onResponse(Call<List<truckTypeBean>> call, Response<List<truckTypeBean>> response) {
                ...
                ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(Materials2.this,
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (length.getText().toString().length() > 0 && width.getText().toString().length() > 0 && height.getText().toString().length() > 0) {
                    ...
                    Intent intent = new Intent(Materials2.this, SelectSpace2.class);
                    ...
                    Toast.makeText(Materials2.this, "Please fill all fields", Toast.LENGTH_SHORT).show();
                }
