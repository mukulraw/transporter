...
import com.app.onnwaytransporter.ordersPOJO.Datum;
 ...
 */
public class PastOrderFragment2 extends Fragment {
    ...
    public void onResume() {
        ...
        Call<ordersBean> call = cr.getCompletedOrders2(SharePreferenceUtils.getInstance().getString("userId"));
