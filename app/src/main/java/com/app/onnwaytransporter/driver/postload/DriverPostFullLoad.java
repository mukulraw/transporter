package com.app.onnwaytransporter.driver.postload;
...
import com.app.onnwaytransporter.PostTruckDataDetails;
...
public class DriverPostFullLoad extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver_post_full_load);
        ...
        //adding toolbar
        Toolbar mToolbar = (Toolbar) findViewById(R.id.toolbar_post_full_load_driver);
        mToolbar.setTitle(getString(R.string.post_full_load_driver));
        ...
        //Post Truck Button
        postTruckBtn = (Button) findViewById(R.id.post_truck_btn);
                ...
                builder.setTitle("Select the type of Truck")
                        ...
                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Toast.makeText(DriverPostFullLoad.this, selectedTruck[0], Toast.LENGTH_LONG).show();
        ...
        scheduleDate_ll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                picker = new DatePickerDialog(DriverPostFullLoad.this,
...
//                                    progressBar.setVisibility(View.VISIBLE);
                                    ...
                                    postTruckDataDetails.mobile_no = DriverMainActivity.currenntMobileActive;
                                    postTruckDataDetails.type = "2";
                                    ...
                                    Toast.makeText(DriverPostFullLoad.this,postTruckDataDetails.vehicle_type, Toast.LENGTH_SHORT).show();
                                    new Post().doPostPostTruc(DriverPostFullLoad.this, postTruckDataDetails);
//                                    Fragment frg = null;
...
//                                    startActivity(intent);
                ...
                if (flagSource == 0) {
                    ...
                    Toast.makeText(DriverPostFullLoad.this, "Please select Start Location", Toast.LENGTH_LONG).show();

                } else if (flagDest == 0) {

                    Toast.makeText(DriverPostFullLoad.this, "Please select Drop Location", Toast.LENGTH_LONG).show();

                } else if (flagTruckType == 0) {

                    Toast.makeText(DriverPostFullLoad.this, "Please select Truck Type", Toast.LENGTH_LONG).show();

                } else if (flagSchDate == 0) {

                    Toast.makeText(DriverPostFullLoad.this, "Please select Schedule Date", Toast.LENGTH_LONG).show();
    ...
    private void getLocation() {
        ...
        Places.initialize(DriverPostFullLoad.this, "AIzaSyDD5e-SJP_E8SDLOHYz79IR79pVy6YQOgg");

        // Create a new Places client instance.
        PlacesClient placesClient = Places.createClient(DriverPostFullLoad.this);
        ...
        if(locationIdentification == 1) {
            if (requestCode == AUTOCOMPLETE_REQUEST_CODE) {
                if (resultCode == RESULT_OK) {
                    ...
                    Toast.makeText(DriverPostFullLoad.this,place.toString(), Toast.LENGTH_SHORT).show();
                } else if (resultCode == AutocompleteActivity.RESULT_ERROR) {
                    // TODO: Handle the error.
                    Status status = Autocomplete.getStatusFromIntent(data);
                    Toast.makeText(DriverPostFullLoad.this,status.toString(),Toast.LENGTH_SHORT).show();
