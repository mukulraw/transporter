...
import com.app.onnwaytransporter.providerpartload.PartLoadMaterialDetails;
 ...
 */
public class PartLoadPostTruck extends Fragment {
    ...
    private Button postTruckNextBtn;
    ...
    public static String SourceAdd, DestAdd, TruckType, schDate;


    public PartLoadPostTruck() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.part_load_post_truck_frag, container, false);
        ...
        //Post Truck Button
        postTruckNextBtn = (Button) view.findViewById(R.id.post_truck_next_btn);
                        ...
                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (flagSchDate + flagDest + flagSource + flagTruckType == 4) {
                                    postTruckNextBtn.setBackground(getResources().getDrawable(R.color.active_button));
                                }
                                Toast.makeText(getContext(), selectedTruck[0], Toast.LENGTH_LONG).show();
                                if (selectedTruck[0] == null) {
                                    flagTruckType = 0;
                                    postTruckNextBtn.setBackground(getResources().getDrawable(R.color.inactive_button));
                                }
        ...
        postTruckNextBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (flagSource == 1 && flagDest == 1 && flagSchDate == 1 && flagTruckType == 1) {

                    postTruckNextBtn.setClickable(true);
                    SourceAdd = sourceLoc.getText().toString();
                    DestAdd = destLoc.getText().toString();
                    TruckType = findVehicleType(displaySelectedTruck.getText().toString());
                    schDate = displayScheduleDate.getText().toString();

                    Intent intent = new Intent(getContext(), PartLoadMaterialDetails.class);
