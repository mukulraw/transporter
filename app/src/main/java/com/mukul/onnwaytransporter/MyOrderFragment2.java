...
import com.mukul.onnwaytransporter.tablayout.ViewPagerAdapter;
...
public class MyOrderFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewPagerAdapter.addFragment(new OngoingOrderFragment2(), "Ongoing");
        viewPagerAdapter.addFragment(new PastOrderFragment2(), "Past");
